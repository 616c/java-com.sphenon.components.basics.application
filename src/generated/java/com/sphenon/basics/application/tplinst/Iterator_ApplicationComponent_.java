...
public interface Iterator_ApplicationComponent_
    extends com.sphenon.basics.many.Iterator<ApplicationComponent>
{
    ...
    public Iterator_ApplicationComponent_ clone(CallContext context);
}
