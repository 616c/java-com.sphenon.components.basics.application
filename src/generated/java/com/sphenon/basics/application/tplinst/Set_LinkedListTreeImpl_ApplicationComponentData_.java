...
public class Set_LinkedListTreeImpl_ApplicationComponentData_
  implements Set_ApplicationComponentData_
{
    private java.util.LinkedList linked_list;

    public Set_LinkedListTreeImpl_ApplicationComponentData_ (CallContext context)
    {
        linked_list = new java.util.LinkedList ();
    }

    public Set_LinkedListTreeImpl_ApplicationComponentData_ (CallContext context, java.util.LinkedList linked_list)
    {
    ...
    public void     set     (CallContext context, Set_LinkedListTreeImpl_ApplicationComponentData_ item_set)
    {
    ...
    public void     add     (CallContext context, Set_LinkedListTreeImpl_ApplicationComponentData_ item_set) throws AlreadyExists
    {
    ...
    public void     unset   (CallContext context, Set_LinkedListTreeImpl_ApplicationComponentData_ item_set)
    {
    ...
    {
        return new Set_LinkedListTreeIteratorImpl_ApplicationComponentData_ (context, linked_list);
    }
    ...
    public long     getSize (CallContext context)
    {
        ...
        for (Object o : linked_list) {
            size += (o instanceof Set_ApplicationComponentData_ ? ((Set_ApplicationComponentData_) o).getSize(context) : 1);
        }
        return size;
    }
}
