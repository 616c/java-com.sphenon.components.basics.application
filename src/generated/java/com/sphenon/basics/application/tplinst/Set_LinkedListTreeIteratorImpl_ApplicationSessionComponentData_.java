...
public class Set_LinkedListTreeIteratorImpl_ApplicationSessionComponentData_
    implements Iterator_ApplicationSessionComponentData_
{
    ...
    Set_LinkedListTreeIteratorImpl_ApplicationSessionComponentData_ sub_iterator;
    private ApplicationSessionComponentData current;

    public Set_LinkedListTreeIteratorImpl_ApplicationSessionComponentData_ (CallContext context, java.util.LinkedList linked_list) {
    ...
    public void     next          (CallContext context)
    {
        ...
        if (this.list_iterator.hasNext()) {
            ...
            if (o == null || o instanceof ApplicationSessionComponentData) {
                this.current = (ApplicationSessionComponentData) o;
            } else {
                Set_LinkedListTreeImpl_ApplicationSessionComponentData_ sllti = ((Set_LinkedListTreeImpl_ApplicationSessionComponentData_)o);
                sub_iterator = (Set_LinkedListTreeIteratorImpl_ApplicationSessionComponentData_) (sllti.getNavigator(context));
                if (sub_iterator.canGetCurrent(context)) {
                    this.current = sub_iterator.tryGetCurrent(context);
                } else {
                    sub_iterator = null;
    ...
    public SetIteratorImpl_ApplicationSessionComponentData_ clone(CallContext context) {
