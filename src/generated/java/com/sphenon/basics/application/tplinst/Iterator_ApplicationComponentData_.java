...
public interface Iterator_ApplicationComponentData_
    extends com.sphenon.basics.many.Iterator<ApplicationComponentData>
{
    ...
    public Iterator_ApplicationComponentData_ clone(CallContext context);
}
