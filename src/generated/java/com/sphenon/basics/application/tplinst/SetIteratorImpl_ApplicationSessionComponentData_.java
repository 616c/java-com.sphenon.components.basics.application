...
public class SetIteratorImpl_ApplicationSessionComponentData_
    implements Iterator_ApplicationSessionComponentData_
{
    ...
    public SetIteratorImpl_ApplicationSessionComponentData_ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        ...
        if (this.iterator.hasNext()) {
            ...
            this.current = (ApplicationSessionComponentData) me.getValue();
        } else {
            this.current = null;
        }
    }
