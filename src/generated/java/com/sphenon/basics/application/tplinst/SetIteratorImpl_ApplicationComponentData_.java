...
public class SetIteratorImpl_ApplicationComponentData_
    implements Iterator_ApplicationComponentData_
{
    ...
    public SetIteratorImpl_ApplicationComponentData_ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        ...
        if (this.iterator.hasNext()) {
            ...
            this.current = (ApplicationComponentData) me.getValue();
        } else {
            this.current = null;
        }
    }
