...
public class VectorReferenceToMember_ApplicationComponent_long_
    implements ReferenceToMember_ApplicationComponent_long_ReadOnlyVector_ApplicationComponent_long__
{
    private ReadOnlyVector_ApplicationComponent_long_ vector;
    private long                          index;

    public VectorReferenceToMember_ApplicationComponent_long_ (CallContext context, ReadOnlyVector_ApplicationComponent_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ApplicationComponent get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_ApplicationComponent_long_)) return false;
        if (((VectorReferenceToMember_ApplicationComponent_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_ApplicationComponent_long_) object).index  != this.index ) return false;
        return true;
    }
