...
public class SetImpl_ApplicationInstanceComponentData_
  implements Set_ApplicationInstanceComponentData_
{
    private java.util.Hashtable map;

    public SetImpl_ApplicationInstanceComponentData_ (CallContext context)
    {
    }
    ...
    public SetImpl_ApplicationInstanceComponentData_ (CallContext context, java.util.Hashtable map)
    {
        this.map = map;
    }
    ...
    {
        initialise(context);
        return new SetIteratorImpl_ApplicationInstanceComponentData_ (context, map);
    }
