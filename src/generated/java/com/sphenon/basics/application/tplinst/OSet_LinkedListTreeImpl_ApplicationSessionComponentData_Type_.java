...
public class OSet_LinkedListTreeImpl_ApplicationSessionComponentData_Type_
  implements OSet_ApplicationSessionComponentData_Type_ {
    protected java.util.Hashtable map;
    protected Set_LinkedListTreeImpl_ApplicationSessionComponentData_ toplevel_set;
    protected Type itemtype;


    public OSet_LinkedListTreeImpl_ApplicationSessionComponentData_Type_ (CallContext context) {
        this.map = new java.util.Hashtable ();
        this.toplevel_set = new Set_LinkedListTreeImpl_ApplicationSessionComponentData_ (context);
        this.itemtype = TypeManager.get(context, ApplicationSessionComponentData.class);
        map.put(this.itemtype, this.toplevel_set);
    }

    public OSet_LinkedListTreeImpl_ApplicationSessionComponentData_Type_ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        this.toplevel_set = new Set_LinkedListTreeImpl_ApplicationSessionComponentData_ (context);
        this.itemtype = TypeManager.get(context, ApplicationSessionComponentData.class);
        map.put(this.itemtype, this.toplevel_set);
    ...
    public Set_ApplicationSessionComponentData_ tryGet  (CallContext context, Type index) {
        ...
        return (Set_ApplicationSessionComponentData_) map.get(index);
    }
    ...
    private Set_LinkedListTreeImpl_ApplicationSessionComponentData_ getEntry(CallContext context, Type index) {
        Set_LinkedListTreeImpl_ApplicationSessionComponentData_ set = (Set_LinkedListTreeImpl_ApplicationSessionComponentData_) map.get(index);
        if (set == null) {
            set = new Set_LinkedListTreeImpl_ApplicationSessionComponentData_ (context);
            map.put(index, set);
    ...
    private void    _setSuper  (CallContext context, Type index, Set_LinkedListTreeImpl_ApplicationSessionComponentData_ sllti) {
    ...
    private void    _unsetSuper  (CallContext context, ApplicationSessionComponentData item, Type index, Set_LinkedListTreeImpl_ApplicationSessionComponentData_ sllti) {
        if (index.equals(itemtype)) return;
        // Iterator_Type_ supertypes = index.getSuperTypes(context).getNavigator(context);
        Iterator_Type_ supertypes = index.getAllShortestPathSuperInterfaces(context).getNavigator(context);
        Type supertype;
    ...
    public void     set     (CallContext context, ApplicationSessionComponentData item) {
        ...
        Set_LinkedListTreeImpl_ApplicationSessionComponentData_ entry = this.getEntry(context, index);
